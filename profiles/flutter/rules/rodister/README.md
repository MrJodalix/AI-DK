...
| Datei | Thema |
|-------|--------|
| `aidk.mdc` | Bootstrap-Pfade, Verkürzung, Stack-Ausnahme, **Qualität nach Merge/Rebase** |
...
| `one-class-per-file.mdc` | Eine Klasse pro Datei / Feature-Ordner; Domain-Layout bei Merge |
