...
Dieses Projekt implementiert die AI-DK-Spezifikation in Version **2.3.2**. AI-DK ist die verbindliche Arbeitsgrundlage für Analyse, Planung, Implementierung, Tests und Dokumentation. Beginne jede neue Aufgabe mit dem Bootstrap-Prozess gemäß [`01_BOOTSTRAP.md`](.ai/01_BOOTSTRAP.md) und befolge anschließend die für die Aufgabe relevanten Core-Dokumente (und ggf. das aktive Profile).
...
| Status | Spezifikation · Flutter-Profile · Extensions · CI · Klarstellungen Offline/HTTP · Fortsetzung · Migrations-Tests |
...
| **2.3.0** | Extensions + CI |
| **2.3.2** | Klarstellungen Greenfield · Shared Core · Git-Abschluss · Flutter-Stack — **aktuell** |
